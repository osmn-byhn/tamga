...
import { Copy, Eye, EyeOff, Trash2, ShieldAlert, Pencil, ExternalLink, GripVertical, Globe } from "lucide-react";
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2">
                            <div className="p-2 rounded-full bg-rose-500/10 text-rose-500 overflow-hidden">
                                {recovery.url ? (
                                    <img src={getFaviconUrl(recovery.url)} alt="" className="h-4 w-4 object-contain" />
                                ) : (
                    ...
                    <div className="flex flex-row flex-wrap items-center justify-end gap-1 pt-2 border-t border-border/50">
                        ...
                        {recovery.url && (
                            <Button
                                ...
                                size="icon"
                                className="h-8 w-8 text-muted-foreground hover:text-foreground"
                                onClick={() => window.open(recovery.url, '_blank')}
                                title="Open Website"
                            >
                                <Globe size={14} />
                            </Button>
